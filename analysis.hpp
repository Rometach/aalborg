...
/* Outputs compression and lose factors for several measures and thresholds */
...
/* Computes the longest equivalent prefix of 'preview' in 'buffer+preview', beginning in 'dictionary'
...
/* Computes and outputs the decompression of the LZ77-compressed sequence 'dico' */
